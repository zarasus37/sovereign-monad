/**
 * Entry point for base-market-agent
 * Handles graceful shutdown on SIGINT/SIGTERM
 */

import { createAgent, BaseMarketAgent } from './agent';
import { createLogger } from './utils/logger';

const logger = createLogger('main');

let agent: BaseMarketAgent | null = null;

async function main(): Promise<void> {
  logger.info('Starting base-market-agent');
