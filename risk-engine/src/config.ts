...
export function getConfig(): Config {
  ...
  configInstance = {
    ...
    evMinThreshold: parseFloat(process.env.EV_MIN_THRESHOLD || '25'),
    sharpeLikeThreshold: parseFloat(process.env.SHARPE_LIKE_THRESHOLD || '0.75'),
    maxTailLossPercent: parseFloat(process.env.MAX_TAIL_LOSS_PERCENT || '10'),
    fixedCostBps: parseFloat(process.env.RISK_FIXED_COST_BPS || '10'),
    minEffectiveSpreadBps: parseFloat(process.env.RISK_MIN_EFFECTIVE_SPREAD_BPS || '15'),
