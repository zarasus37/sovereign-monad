...
exports.HeparPrivilegeAgent = void 0;
const stageC_utils_1 = require("../stages/stageC-utils");
class HeparPrivilegeAgent {
    constructor(seed) {
        this.seed = seed;
        this.agentId = 'PRIVILEGE';
        this.findings = [];
...
exports.HeparPrivilegeAgent = HeparPrivilegeAgent;
//# sourceMappingURL=HeparPrivilegeAgent.js.map