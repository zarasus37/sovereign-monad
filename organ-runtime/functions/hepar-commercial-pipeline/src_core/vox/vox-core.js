...
exports.distributeIntelligence = exports.verifyTruthAndDetectManipulation = exports.captureNarratives = void 0;
...
function verifyTruthAndDetectManipulation(protocolId, claims, heparCtx, cortexCtx, pneumaCtx) {
    ...
    const verifiedClaims = claims.map(c => {
        ...
        if (text.includes("security architecture is battle-tested") || text.includes("no known vulnerabilities") || text.includes("treasury is fully protected")) {
            if ((pneumaCtx === null || pneumaCtx === void 0 ? void 0 : pneumaCtx.convertedDemand) && (heparCtx === null || heparCtx === void 0 ? void 0 : heparCtx.classification) === 'HARDBLOCK') {
                status = 'CONTRADICTED';
            }
        }
        // Fixture 4 logic
        ...
        if (status === 'UNVERIFIED')
            unverifiedCount++;
        return Object.assign(Object.assign({}, c), { status });
    });
    let manipulationConfidence = 'LOW';
    let triggersImmediateSynapse = false;
    if (contradictedCount >= 3 && (pneumaCtx === null || pneumaCtx === void 0 ? void 0 : pneumaCtx.convertedDemand)) {
...
//# sourceMappingURL=vox-core.js.map