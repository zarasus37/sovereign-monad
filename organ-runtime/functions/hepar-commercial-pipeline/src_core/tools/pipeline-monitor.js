...
function safeFetch(containerName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const container = yield (0, cosmos_config_1.getContainer)(containerName);
...
function runMonitor() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const leads = yield safeFetch("leads");
        ...
        const opps = yield safeFetch("opportunities");
        ...
        const props = yield safeFetch("proposals");
        ...
        const outreachList = yield safeFetch("outreach");
        ...
        const clients = yield safeFetch("clients");
        let activeClients = 0;
        clients.forEach(c => {
