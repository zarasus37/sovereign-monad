...
function buildCurveFinanceInput() {
    ...
    const eL = { low: 10000000, high: 100000000 };
    return {
...
// Cosmos DB writer
// ---------------------------------------------------------------------------
function writeToCosmosOpportunities(cosmosRefs, entry, isWildcard) {
...
function printSummaryTable(entries) {
    ...
    for (const entry of entries) {
        ...
        const converge = (_a = top === null || top === void 0 ? void 0 : top.convergenceLabel) !== null && _a !== void 0 ? _a : '—';
        ...
        const tier = (actualTier !== null && actualTier !== void 0 ? actualTier : '—').padEnd(14);
        console.log([
    ...
    if (diverged.length > 0) {
        ...
        for (const d of diverged) {
            ...
            const actual = (_b = d.actualTier) !== null && _b !== void 0 ? _b : '?';
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < batch.length; i++) {
            ...
            try {
                ...
                yield writeToCosmosOpportunities(cosmosRefs, entry, entry.isWildcard);
...
//# sourceMappingURL=liveAssessmentBatch01.js.map