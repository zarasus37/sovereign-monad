...
async function runProposalGenerationEngine() {
    ...
    const cortexResearchContainer = await (0, cosmosClient_1.getCortexContainer)("cortex-research");
    const synapseCoordContainer = await (0, cosmosClient_2.getSynapseContainer)("synapse-coordination");
    const pneumaMarketContainer = await (0, cosmosClient_3.getPneumaContainer)("pneuma-market");
    const pneumaRegimeContainer = await (0, cosmosClient_3.getPneumaContainer)("pneuma-regime");
    const pneumaExecContainer = await (0, cosmosClient_3.getPneumaContainer)("pneuma-execution");
    const voxIntegrityContainer = await (0, cosmosClient_4.getVoxContainer)("vox-integrity");
    const voxDistContainer = await (0, cosmosClient_4.getVoxContainer)("vox-distribution");
