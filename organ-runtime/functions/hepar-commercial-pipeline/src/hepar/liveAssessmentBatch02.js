...
async function fetchBytecode(address, label) {
...
// ---------------------------------------------------------------------------
async function writeToCosmosOpportunitiesBatch02(cosmosRefs, entry, bytecodeAnalysis) {
...
async function main() {
    ...
    for (let i = 0; i < batch.length; i++) {
        ...
        const absentIds = input.confirmedAbsentTemplateIds ?? [];
        ...
        try {
            ...
            await writeToCosmosOpportunitiesBatch02(cosmosRefs, entry, bcA);
