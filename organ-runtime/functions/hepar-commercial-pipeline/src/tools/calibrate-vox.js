...
async function runCalibration() {
    ...
    let distContainer;
    try {
        await (0, cosmosClient_1.initVox)();
        integrityContainer = await (0, cosmosClient_1.getVoxContainer)('vox-integrity');
        distContainer = await (0, cosmosClient_1.getVoxContainer)('vox-distribution');
    }
    catch (e) {
