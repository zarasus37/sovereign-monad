...
exports.initCortex = exports.getCortexContainer = void 0;
...
function getCortexContainer(containerId) {
...
function initCortex() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield getCortexContainer('cortex-research');
        yield getCortexContainer('cortex-mandates');
        yield getCortexContainer('cortex-signals');
