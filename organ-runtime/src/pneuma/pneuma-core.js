...
exports.generatePneumaIntelligence = exports.classifyRegime = exports.evaluateExecutionIntelligence = exports.detectConvertedDemand = exports.CAL_005_PARAMS = void 0;
exports.CAL_005_PARAMS = {
...
function detectConvertedDemand(raw) {
    let flags = 0;
    if (raw.unusualOptionsActivity)
        flags++;
    if (raw.largeLpWithdrawals)
        flags++;
    if (raw.shortInterestSpike)
        flags++;
    if (raw.walletClustering)
        flags++;
    return flags >= 1; // Any confirmed signal triggers converted demand
}
exports.detectConvertedDemand = detectConvertedDemand;
function evaluateExecutionIntelligence(raw, isUrgent = false) {
    const latencyMs = raw.latencyMs || 500;
    const baseCost = raw.baseExecutionCostBps || 5;
    const penaltyDivisor = isUrgent ? exports.CAL_005_PARAMS.urgentLatencyPenaltyDivisor : exports.CAL_005_PARAMS.normalLatencyPenaltyDivisor;
    ...
    return {
        ...
        isReliable: settlementReliability >= exports.CAL_005_PARAMS.minSettlementReliability
    };
}
exports.evaluateExecutionIntelligence = evaluateExecutionIntelligence;
function classifyRegime(raw, convertedDemand) {
    let regime = 'NORMAL';
    let confidence = 0.90;
...
exports.classifyRegime = classifyRegime;
function generatePneumaIntelligence(raw, isUrgent = false) {
...
exports.generatePneumaIntelligence = generatePneumaIntelligence;
//# sourceMappingURL=pneuma-core.js.map