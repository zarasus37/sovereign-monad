...
exports.runStageA = exports.walletTaintAdvisoryStub = exports.computeSurfaceScore = exports.deductForSeverity = void 0;
// ---------------------------------------------------------------------------
// Scoring helpers
// ---------------------------------------------------------------------------
...
function runStageA(findings, runId) {
    ...
    return {
        ...
        stageARunId: runId !== null && runId !== void 0 ? runId : `stageA-${Date.now()}-advisory`,
        completedAt: Date.now(),
    };
}
exports.runStageA = runStageA;
//# sourceMappingURL=stageA-static.js.map