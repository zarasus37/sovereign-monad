...
exports.runStageB = exports.AdvisoryStubEngine = exports.symbolicProofterm = exports.DEFAULT_INVARIANTS = void 0;
...
class AdvisoryStubEngine {
    constructor(options = {}) {
        var _a, _b, _c;
        this.counterexamples = (_a = options.knownCounterexamples) !== null && _a !== void 0 ? _a : new Map();
        this.provedSafe = (_b = options.knownProvedSafe) !== null && _b !== void 0 ? _b : new Set();
        this.timeoutMs = (_c = options.defaultTimeoutMs) !== null && _c !== void 0 ? _c : 30000;
    }
    check(invariant) {
...
function runStageB(input = {}) {
    var _a, _b, _c;
    const invariants = (_a = input.invariants) !== null && _a !== void 0 ? _a : exports.DEFAULT_INVARIANTS;
    const engine = (_b = input.engine) !== null && _b !== void 0 ? _b : new AdvisoryStubEngine();
    const runId = (_c = input.runId) !== null && _c !== void 0 ? _c : `stageB-${Date.now()}-advisory`;
    let allLive = true;
...
//# sourceMappingURL=stageB-symbolic.js.map