...
exports.createDefaultHeparOrchestrator = exports.HeparOrchestrator = void 0;
...
class HeparOrchestrator {
     ...
     */
    executeFullPipeline(protocolId, addressesToProbe) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                stageAResult = yield this.stageA.analyze(protocolId, addressesToProbe);
                ...
                stageBResult = yield this.stageB.prove(protocolId, stageAResult.findings.map(f => f.vectorId));
                ...
                stageCResult = yield this.stageC.execute(protocolId, addressesToProbe);
     ...
     */
    executeUpToStage(stage, protocolId, addressesToProbe) {
        return __awaiter(this, void 0, void 0, function* () {
            const startTime = performance.now();
            let stageAResult = null;
            let stageBResult = null;
...
//# sourceMappingURL=HeparOrchestrator.js.map