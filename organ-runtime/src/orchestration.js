...
exports.buildOrchestrationSnapshot = void 0;
const PHASES = [
...
function buildOrchestrationSnapshot(implementedOrgans) {
    const missing = PHASES.filter((phase) => !implementedOrgans.includes(phase.owner)).map((phase) => `${phase.owner} missing for ${phase.name}`);
...
exports.buildOrchestrationSnapshot = buildOrchestrationSnapshot;
