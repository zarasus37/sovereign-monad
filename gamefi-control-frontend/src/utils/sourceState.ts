import { GameFiSourceConfig, SourceHealthSnapshot, SourceLifecycleState } from '../types';
...
export function buildSnapshotFromConfig(config: GameFiSourceConfig): SourceHealthSnapshot {
  return {
    ...
    configDriven: true,
    note:
      'State derived locally from gamefi-source config. ' +
